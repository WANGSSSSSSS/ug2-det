...
class UG2Dataset(CustomDataset):
    ...
    def __init__(self, min_size=None, **kwargs):
        ...
        super(UG2Dataset, self).__init__(**kwargs)
...
if __name__ == "__main__":
    dataset = UG2Dataset(classes=["car", "bus", "bicycle", "motorcycle", "person"],
   ...
   # dataset.load_annotations("/home/wang_shuai/RTTS/ImageSets/Main/test.txt")
